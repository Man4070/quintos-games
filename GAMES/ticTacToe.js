...
async function takeTurn(row, col) {
	...
	if (board[row][col] != ' ') {
		...
		if (turnX == true) {
			pc.text("Player X's turn", 55, 4);
		} else {
			pc.text("Player O's turn", 55, 4);
		}
